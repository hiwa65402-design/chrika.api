        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupPostId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Comment_EntityType", "(`PostId` IS NOT NULL AND `GroupPostId` IS NULL) OR (`PostId` IS NULL AND `GroupPostId` IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Like_EntityType", "(`PostId` IS NOT NULL AND `GroupPostId` IS NULL) OR (`PostId` IS NULL AND `GroupPostId` IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_UserId_GroupPostId",
                table: "Likes",
